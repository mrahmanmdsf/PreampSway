 ...
 * This file demonstrates how to integrate Preampsway with a web frontend
 */

// For React/Vue/Angular applications
export class PreampswayClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new PreampswayClient(provider, contractAddress);
